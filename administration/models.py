...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    #ex:1_sdfs2.jpg 
    head_portrait   	 = models.ImageField(u'选择头像',  upload_to='portrait',default='/media/portrait/no_img/no_portrait1.jpg')	
    ...
    thumbnail_portait    = models.ImageField(u'头像缩略图',  upload_to='portrait',default='/media/portrait/no_img/no_portrait1.jpg')
